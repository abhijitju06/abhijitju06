...
[xe_fis_6, estimated_parameter_fis_6, Error_fis_6]= CRFIEKF_Tikhonov_FIS_6_output(time, model, jac, H , Q, R, xe0, Pe0, D, d, alpha);
disp('Parameter estimation complited with 6 FIS output')
...
H(5,16) = 1;
R = eye(5)*0.001;
[xe_fis_5, estimated_parameter_fis_5, Error_fis_5]= CRFIEKF_Tikhonov_FIS_5_output(time, model, jac, H , Q, R, xe0, Pe0, D, d, alpha);
disp('Parameter estimation complited with 5 FIS output')
...
H(4,4) = 1;
R = eye(4)*0.001;
[xe_fis_4, estimated_parameter_fis_4, Error_fis_4]= CRFIEKF_Tikhonov_FIS_4_output(time, model, jac, H , Q, R, xe0, Pe0, D, d, alpha);
disp('Parameter estimation complited with 4 FIS output')
...
H(6,4) = 1;
R = eye(6)*0.001;
[xe_without_reg, estimated_parameter_without_reg, Error_without_reg]= CRFIEKF_run_without_regularization(time, model, jac, H , Q, R, xe0, Pe0, D, d, alpha);
disp('Parameter estimation complited without regularization')
